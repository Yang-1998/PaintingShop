                ...
                <form action="${ pageContext.request.contextPath }/ProductServlet?method=save" method="post" enctype="multipart/form-data">
                    <div class="panel-body bg-light">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="pname" name="pname" class="gui-input" placeholder="名称" type="text" value=""/>
                                </label>
                            </div>
                        </div>
						<div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="price" class="gui-input" placeholder="价格" type="text" value=""/>
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="author" class="gui-input" placeholder="作者" type="text" value=""/>
						...
						<div class="section row">
							...
							<div class="col-md-6">
								<label for="address" class="field">
									<input id="address" name="desciption" class="gui-input" placeholder="描述" type="text" value=""/>
								</label>
							</div>
                        </div>

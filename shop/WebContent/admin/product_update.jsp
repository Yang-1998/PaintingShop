    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form id="admin-form" name="addForm" action="${pageContext.request.contextPath}/ProductServlet?method=update&pid=${product.pid}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="pname" class="gui-input" placeholder="名称" type="text" value="${product.pname }"/>
                                </label>
                            </div>
                        </div>
						<div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input id="sn" name="price" class="gui-input" placeholder="1000" type="text" value="${product.price}"/>
